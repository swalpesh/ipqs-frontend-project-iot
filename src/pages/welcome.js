...
export default function Welcome() {
  ...
  const handleCheckboxChange = (e) => {
    ...
    if (checked) {
      setFormData({ ...formData, requirements: [...requirements, value] });
    } else {
      setFormData({ ...formData, requirements: requirements.filter((item) => item !== value) });
    }
  };
  ...
  const submitQuote = async () => {
    try {
      ...
      if (result.success) {
        ...
        setOpenSolution(false); // Close the modal
      } else {
...
useEffect(() => {
  ...
  // --- Custom Pin Icon (your pin.png)
  const customIcon = L.icon({
    iconUrl: pinIcon,
    iconSize: [40, 40],    // adjust as needed
    iconAnchor: [20, 40],  // point of pin
    popupAnchor: [0, -40]
  });
...
{/* 3. FEATURES SECTION */}
{/* 3. FEATURES SECTION (BOOTSTRAP GRID VERSION) */}
    ...
    <div className="row gy-4">
      ...
      <div className="col-12 col-md-6 col-lg-3">
        <Box
          sx={{
            ...
            "&:hover": { transform: "translateY(-6px)", borderColor: "#00d4ff" }
          }}
        >
          <Box sx={{ color: "#00d4ff", mb: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Generate smart, automated reports powered by AI for your ease. Get deep insights without manual calculations.
          </Typography>
        </Box>
      </div>
      ...
      <div className="col-12 col-md-6 col-lg-3">
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary">
            Works with LT/HT panels, APFC, MCC/PCC, solar inverters, and DG sets—all in one dashboard.
          </Typography>
        </Box>
      </div>
      ...
      <div className="col-12 col-md-6 col-lg-3">
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary">
            Connects to any meter or controller supporting Modbus RS485 without complex wiring.
          </Typography>
        </Box>
      </div>
      ...
      <div className="col-12 col-md-6 col-lg-3">
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary">
            Monitor your entire plant from mobile, tablet, or PC from anywhere in the world.
          </Typography>
        </Box>
      </div>
      ...
      {/* 4. APPLICATIONS SECTION - Single Line Layout */}
      <Box id="applications" sx={{ py: 15, bgcolor: "#0b1120" }}>
        <Container maxWidth="xl">
          ...
          <Box sx={{ 
            ...
            "&::-webkit-scrollbar-thumb": { background: "rgba(0, 212, 255, 0.3)", borderRadius: "10px", "&:hover": { background: "#00d4ff" } },
          }}>
            {[
      ...
      {/* 5. BENEFITS SECTION */}
  {/* 5. BENEFITS SECTION (BOOTSTRAP GRID VERSION) */}
<Box id="benefits" sx={{ py: 15, bgcolor: "background.default" }}>
  <div className="container">

    <Box textAlign="center" mb={10}>
      <Typography variant="h3" gutterBottom>
        Business <span style={{ color: "#00d4ff" }}>Benefits</span>
      </Typography>
      <Typography variant="h5" color="text.secondary" fontWeight={400}>
        Why Industry Leaders Choose IPQS
      </Typography>
    </Box>
    ...
    <div className="row gy-4">
      ...
      {[
        ...
        <div className="col-12 col-sm-6 col-md-4 col-lg-2" key={i}>
          <Card sx={{ 
            ...
            border: "1px solid rgba(255,255,255,0.1)",
            transition: "0.3s ease",
            "&:hover": { transform: "translateY(-8px)", borderColor: "#00d4ff" }
          }}>
            <CardContent>
              <Box sx={{ 
      ...
      {/* 6. NETWORK SECTION */}
{/* 6. NETWORK SECTION (BOOTSTRAP GRID VERSION – WORKING) */}
<Box id="network" style={{ padding: "120px 0", background: "#0b1120" }}>
  <div className="container">
    ...
    <div style={{ textAlign: "center", marginBottom: "60px" }}>
      <Typography variant="h3" gutterBottom>
        Our <span style={{ color: "#00d4ff" }}>Network</span>
      </Typography>
      <Typography variant="h5" color="text.secondary" fontWeight={400}>
        Trusted by major industrial players
      </Typography>
    </div>
...
{/* --- MODALS (Code hidden for brevity, logic unchanged) --- */}
        ...
        <DialogContent sx={{ pt: 2 }}>
           ...
           <form>
             ...
             <TextField 
               ...
               SelectProps={{
                 MenuProps: {
                   PaperProps: {
                     sx: {
                       bgcolor: "#1e293b", // Solid background color
             ...
             >
               ...
               <MenuItem value="Solar">Stone Crusher</MenuItem>
               <MenuItem value="Solar">Chemical</MenuItem>
               <MenuItem value="Solar">Food Processing</MenuItem>
               <MenuItem value="Solar">Steel Industry</MenuItem>
             ...
             <Grid container>
               {["LT & HT Panels", "Solar Monitoring", "Distribution Panels", "DG Set"].map(item => (
                 <Grid item xs={6} key={item}>
                   <FormControlLabel control={<Checkbox size="small" />} label={<Typography variant="body1">{item}</Typography>} />
                 </Grid>
               ))}
               <Grid item xs={12}>
                  <FormControlLabel 
             ...
             <Button fullWidth variant="contained" size="large" sx={{ mt: 3, py: 1.5 }}>Request Quote</Button>
           </form>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={openDemo} onClose={() => setOpenDemo(false)} maxWidth="sm" fullWidth PaperProps={{ sx: { bgcolor: "#1e293b", backgroundImage: "none" } }}>
        ...
        <DialogContent>
           ...
           <Button fullWidth variant="contained" size="large" sx={{ mt: 3 }}>Submit Request</Button>
        </DialogContent>
      </Dialog>
